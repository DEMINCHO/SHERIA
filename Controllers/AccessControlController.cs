...
namespace SHERIA.Controllers
{
    ...
    public class AccessControlController : Controller
    {
        ...
        public IActionResult GetMenusJSTree(int profileid)
        {
            ...
            DataTable main_menu_datatable = dbhandler.GetAdhocData("EXEC get_menu_data " + profileid + ", 'main', ''");
            ...
            if (main_menu_datatable.Rows.Count > 0)
            {
                for (int i = 0; i <= main_menu_datatable.Rows.Count - 1; i++)
                {
                    ...
                    DataTable sub_menu_datatable = dbhandler.GetAdhocData("EXEC get_menu_data " + profileid + ", 'sub', '" + main_menu_datatable.Rows[i]["main_menu_name"] + "'");
                    ...
                    {
                        DataTable no_sub_datatable = dbhandler.GetAdhocData("EXEC get_menu_data " + profileid + ", 'page_url', '" + main_menu_datatable.Rows[i]["main_menu_name"].ToString() + "'");
